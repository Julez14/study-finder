...
const Map = ({ buildings }) => {
  ...
  // Add the YOU_ARE_HERE constant at the top of the component
  const YOU_ARE_HERE = [-79.918108, 43.265512];
...
`;
      ...
      const existingRouteInfo =
        mapContainer.current.querySelector(".route-info");
  ...
  useEffect(() => {
    ...
    map.current = new mapboxgl.Map({
      ...
      center: [-79.918176, 43.262229], // Adjust these coordinates for your location
      zoom: 16,
      pitch: 65,
      bearing: 120,
    });
    ...
    map.current.on("load", () => {
      ...
      const youAreHereElement = document.createElement("div");
      youAreHereElement.className = "you-are-here-marker";
      youAreHereElement.style.backgroundColor = "#4A90E2";
      youAreHereElement.style.width = "20px";
      youAreHereElement.style.height = "20px";
      youAreHereElement.style.borderRadius = "50%";
      youAreHereElement.style.border = "3px solid white";
      youAreHereElement.style.boxShadow = "0 0 0 2px #4A90E2";

      new mapboxgl.Marker({
        element: youAreHereElement,
      })
